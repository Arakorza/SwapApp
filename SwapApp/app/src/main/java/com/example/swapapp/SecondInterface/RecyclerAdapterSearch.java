...
public class RecyclerAdapterSearch extends RecyclerView.Adapter<RecyclerAdapterSearch.MyViewHolder> {
    ...
    public RecyclerAdapterSearch(ArrayList<String> postIDs) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(final View view) {
            ...
            title = view.findViewById(R.id.title_PostItemSearch);
            time = view.findViewById(R.id.time_PostItemSearch);
            description = view.findViewById(R.id.description_PostItemSearch);
            username = view.findViewById(R.id.username_PostItemSearch);
            email = view.findViewById(R.id.email_PostItemSearch);
            numOfRatings = view.findViewById(R.id.numOfRatings_PostItemSearch);
            numOfTrades = view.findViewById(R.id.numOfTrades_PostItemSearch);

            rating1 = view.findViewById(R.id.rating1_PostItemSearch);
            rating2 = view.findViewById(R.id.rating2_PostItemSearch);
            rating3 = view.findViewById(R.id.rating3_PostItemSearch);
            rating4 = view.findViewById(R.id.rating4_PostItemSearch);
            rating5 = view.findViewById(R.id.rating5_PostItemSearch);

            image = view.findViewById(R.id.image_PostItemSearch);
            pfp = view.findViewById(R.id.pfp_PostItemSearch);
            wishlistedIcon = view.findViewById(R.id.wishlistedIcon_PostItemSearch);

            mainLayout = view.findViewById(R.id.mainLayout_PostItemSearch);
        }
    ...
    public RecyclerAdapterSearch.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.post_list_item_search, parent, false);
            ...
            public void onClick(View v) {
                ...
                mFirebase.child("Users").child(uid).child("wishlist").addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        for (DataSnapshot wishlistSnapShop : snapshot.getChildren()) {
                            int tempKey = Integer.valueOf(wishlistSnapShop.getKey());
                            if (tempKey > largestKey) {
                                largestKey = tempKey;
                            }
                        }
                ...
                String addedKey = String.valueOf(largestKey + 1);
                mFirebase.child("Users").child(uid).child("wishlist").child(addedKey).setValue(currentPostID);
                ...
                addedKey = String.valueOf(largestKey + 1);
                mFirebase.child("Posts").child(currentPostID).child("wishlistBy").child(addedKey).setValue(uid);
            }
        });
